...
export default function Navbar({ 
  ...
  const navLinks = [
    ...
    { name: 'Franchise', href: '#franchise', handler: handleFranchiseClickInternal, title: 'Franchise Opportunities - Own a LaundryForAll', rel: 'franchise' }
  ];

  // Left side links: Home, Services, Pricing, Contact (moved Contact to left)
  const leftLinks = [
    { name: 'Home', href: '#home', handler: handleHomeClickInternal, title: 'LaundryForAll - Professional Laundry Services', rel: 'home' },
    { name: 'Services', href: '#services', handler: handleServicesClickInternal, title: 'Our Laundry Services - Wash, Dry, Fold & More', rel: 'services' },
    { name: 'Pricing', href: '#pricing', handler: handlePricingClickInternal, title: 'Affordable Laundry Pricing - Transparent Rates', rel: 'pricing' },
  ...
  // Right side links: Franchise, About (removed Contact from right)
  const rightLinks = [
    { name: 'Franchise', href: '#franchise', handler: handleFranchiseClickInternal, title: 'Franchise Opportunities - Own a LaundryForAll', rel: 'franchise' },
    { name: 'About', href: '#about', handler: handleAboutClickInternal, title: 'About LaundryForAll - Your Trusted Laundry Partner', rel: 'about' },
  ];
  ...
  const renderNavLink = (link) => (
    <a
      ...
      itemProp="url"
      className="relative px-3 lg:px-4 xl:px-5 py-2 text-sm lg:text-base xl:text-lg font-black transition-all duration-300 group whitespace-nowrap"
    >
      <span 
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20 lg:h-24">
          {/* Desktop: Left nav links - Now includes Contact */}
          <div className="hidden md:flex md:items-center md:space-x-1 lg:space-x-2 xl:space-x-4 flex-1 min-w-0">
            {leftLinks.map(renderNavLink)}
          </div>

          {/* Logo - Absolute centered with increased left/right spacing */}
          ...
          {/* Desktop: Right nav links + Book Now - Now includes only Franchise and About */}
          <div className="hidden md:flex md:items-center md:space-x-1 lg:space-x-2 xl:space-x-4 flex-1 justify-end min-w-0 pl-8 lg:pl-12 xl:pl-16">
            ...
            <div className="relative group ml-2 flex-shrink-0">
              ...
              <a
                ...
                className="relative bg-gradient-to-r from-[#1aa6b3] to-teal-400 hover:from-[#147c86] hover:to-teal-500 text-white px-5 lg:px-6 xl:px-8 py-2.5 lg:py-3 text-sm lg:text-base font-black rounded-xl transition-all duration-300 transform hover:scale-105 flex items-center gap-2 shadow-lg hover:shadow-2xl overflow-hidden whitespace-nowrap"
              >
